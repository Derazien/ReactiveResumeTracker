...
export class ContentLibraryService {
  ...
  async create(
    ...
    const { tagIds, content, skills, achievements, ...contentData } = createContentLibraryDto;
  ...
  async update(
    ...
    const { tagIds, content, skills, achievements, ...updateData } = updateContentLibraryDto;
