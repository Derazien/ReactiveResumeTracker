...
export const CoverLetterBuilderLayout = () => {
  const { isDesktop } = useBreakpoint();

  const sheet = useCoverLetterBuilderStore((state) => state.sheet);

  const leftSetSize = useCoverLetterBuilderStore((state) => state.panel.left.setSize);
  const rightSetSize = useCoverLetterBuilderStore((state) => state.panel.right.setSize);

  const leftHandle = useCoverLetterBuilderStore((state) => state.panel.left.handle);
  const rightHandle = useCoverLetterBuilderStore((state) => state.panel.right.handle);
